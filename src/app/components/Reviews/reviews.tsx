      ...
      <Container>
        <div className={styles.headerContainer}>
          ...
          <Image
            ...
            unoptimized
          />
          <div className={styles.bestInTN}>
            <Link target="_blank"
              rel="noopener noreferrer" href="https://www.tripadvisor.it/Restaurants-g1493737-zfd10907-Province_of_Trento_Trentino_Alto_Adige-Hamburger.html">
              <strong>Miglior burger</strong> in Trentino
              <Image
                src="/top-rated-tripadvisor.webp"
