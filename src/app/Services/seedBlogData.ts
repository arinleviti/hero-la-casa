...
export const blogPosts : BlogPost[] = [
    ...
    },
    {
        ...
        content: `
    <p>Noi siamo HERO - La casa del burger e oggi vogliamo raccontarti la storia che monta le redini della nostra attività. HERO è il viaggio al quale ha partecipato il burger, dopo aver viaggiato in giro per tutto il mondo vivendo gli odori e i sapori,
     torna nella sua dimora, la casa del burger per portare colori, sapori e ingredienti dal mondo e racchiuderli all'interno degli HeroBurger.</p>
  `,
...
Infine, ma non per importanza, il quinto elemento che definisce l’eccellenza dei nostri hamburger è la scelta delle salse. Le salse sono la firma finale di ogni hamburger, capaci di legare insieme tutti gli ingredienti, esaltandone i sapori. Da noi, troverete solo le migliori salse tradizionali, come la maionese e il ketchup Heinz, selezionati per la loro qualità indiscussa e capaci di conferire quel tocco classico amato da tutti, per un tocco in più la Cheddar Cheese Sause. La nostra attenzione nella selezione delle salse riflette la nostra passione per i dettagli e il nostro impegno a offrire un’esperienza culinaria senza eguali.</p> `,
  ...
  content: `
    <p>Quest’anno, il 23 settembre, HERO compie anni di attività! Per questo noi di HERO – La casa del burger abbiamo deciso di proprre una promozione fantastica, funziona così:

Se verrete a dal settembre al ottobre, noi vi consegneremo una busta misteriosa alla fine del pasto!
Tutte le buste misteriose contengono un REGALO! Sennò che compleanno sarebbe? Alcuni sono belli, altri bellissimi, altri sono semplicemente pensieri, ma tutte le buste contengono un omaggio
...
<h2>Beer Bash – Bevi e vinci!</h2>< /br>
Un martedì sera diverso da tutti gli altri. È il <strong>Beer Bash</strong>! Ogni martedì di maggio, abbiamo trasformato le vostre serate in un’esperienza indimenticabile, ricca di <strong>birra, risate e premi</strong>.
...
Ma cos’è esattamente il Beer Bash? È la nostra celebrazione della birra artigianale, un evento dove amici e appassionati di birra si incontrano per gustare le nostre migliori selezioni, partecipare a giochi divertenti e vincere fantastici premi. È stata l’occasione perfetta per rilassarsi, socializzare e godersi il meglio che Hero ha da offrire.
<img src="https://res.cloudinary.com/demo/image/upload/sample.jpg" alt="" />
